...
/* USER CODE BEGIN EV */
extern volatile uint16_t dmaRxHead;
extern uint8_t dmaRxBuf[];
extern void process_received_data(uint8_t *data, uint16_t length);
extern void parse_byte(uint8_t b) ;
/* USER CODE END EV */
